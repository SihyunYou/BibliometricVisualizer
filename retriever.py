...
Query = 'TITLE(Photovoltaic) AND PUBYEAR = 2012'
s_rooftop = ScopusSearch(Query, download=True, verbose=True, subscriber = True)

df_bipv = pd.DataFrame(s_rooftop.results)
